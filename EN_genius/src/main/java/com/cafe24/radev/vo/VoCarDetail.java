...
public class VoCarDetail {
	...
	public String toString() {
		return "VoCarDetail [originCode=" + originCode + ", originMain=" + originMain + ", vendorCode=" + vendorCode
				...
				+ lastOptionCode + ", loWriter=" + loWriter + ", loDate=" + loDate + ", fuelCode=" + fuelCode
				+ ", fuelType=" + fuelType + ", fuelWriter=" + fuelWriter + ", fuelDate=" + fuelDate + ", feCode="
				+ feCode + ", engineType=" + engineType + ", feWriter=" + feWriter + ", feDate=" + feDate + ", tmCode="
				+ tmCode + ", tmType=" + tmType + ", tmWriter=" + tmWriter + ", tmDate=" + tmDate + ", dwCode=" + dwCode
				+ ", dwType=" + dwType + ", dwWriter=" + dwWriter + ", dwDate=" + dwDate + ", ptCode=" + ptCode
				+ ", engineForm=" + engineForm + ", ptWriter=" + ptWriter + ", ptDate=" + ptDate + ", colorBigCode="
				+ colorBigCode + ", colorBigName=" + colorBigName + ", cbWriter=" + cbWriter + ", cbDate=" + cbDate
				+ ", colorMidCode=" + colorMidCode + ", colorMidName=" + colorMidName + ", cmdWriter=" + cmdWriter
				+ ", cmdDate=" + cmdDate + ", group_Code=" + group_Code + "]";
	}
